...
public class RoundRectDrawableWithShadow extends Drawable { // changed visibility modifier
    ...
    // changed: replaced sRoundRectHelper with in-place implementation
    private static void drawRoundRect(Canvas canvas, RectF bounds, float cornerRadius, Paint paint) {
        if (Build.VERSION.SDK_INT >= 17) {
            canvas.drawRoundRect(bounds, cornerRadius, cornerRadius, paint);
        } else {
            net.aquadc.tgchart.card.RoundRectHelper.drawRoundRect(canvas, bounds, cornerRadius, paint);
        }
    }
    ...
    private static final int mShadowStartColor = 0x37_000000; // changed to const

    private static final int mShadowEndColor = 0x03_000000; // changed to const
